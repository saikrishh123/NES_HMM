...
%% parameters
File = 'bloutooth_file_transfer.txt';
...
for i = 1:20:numofsamples
    ...
    for j = i+4:i+3+packet_length
        ...
        P_signal = Trans_power(scenario_power) - Loss(scenario_alpha) + X_g;
...
saveas(fig,'PRR_interference_scenario.pdf');
